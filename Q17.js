...
var guestArr = ["Imran", "Saima", "Ali", "Maha"];
console.log("Unfortunately I can invite only two people to Dinner.");
while (guestArr.length > 2) {
    var removeGuest = guestArr.pop();
    console.log("Sorry, ".concat(removeGuest, ", Your are not invited to\n     the Dinner."));
}
guestArr.map(function (item) { return (console.log("Dear, ".concat(item, ", You are still invited to the \n    Dinner."))); });
guestArr.pop();
guestArr.pop();
